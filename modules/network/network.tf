...
resource "aws_subnet" "public_subnets" {
  ...
  tags = {
    "Name" = "Public-Subnet-${count.index + 1}-${var.app}"
  }
}
...
resource "aws_subnet" "private_subnets" {
  ...
  tags = {
    "Name" = "Private-Subnet-${count.index + 1}-${var.app}"
  }
...
resource "aws_route_table" "rt_public_subnets" {
    ...
    tags = {
      "Name" = "Public-Route-Table-${count.index + 1}-${var.app}"
    }
...
resource "aws_route_table" "rt_private_subnets" {
    ...
    tags = {
      "Name" = "Private-Route-Table-${count.index + 1}-${var.app}"
    }
